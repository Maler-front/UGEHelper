...
class FirstTemplate(FirstTaskClass):
    ...
    def displayTask(self):
        ...
        image.show()
        print(f"Радиус основания цилиндра равен {self.r}, а его образующая равна {self.l}. Сечение, параллельное оси цилиндра, удалено от неё на расстояние, равное {self.p}. Найдите площадь этого сечения.")