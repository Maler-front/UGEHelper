...
class SecondTemplate(BaseTaskClass):
    ...
    def get_text(self):
        return "Среднее геометрическое трёх чисел: a, b и c – вычисляется по формуле g = " + degree(3) + u"\u221a" + f"abc . Вычислите среднее геометрическое чисел {self.a}, {self.b} и {self.c}."
