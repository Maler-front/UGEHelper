...
class SecondTemplate(BaseTaskClass):
    ...
    def get_text(self):
        return f"Во дворе школы растут всего три дерева: ясень, рябина и осина. Известно, что {self.trees[1]} выше, чем {self.trees[0]} на 1 метр, но ниже, чем {self.trees[2]} на 2 метра. Выберите все утверждения, которые верны при указанных условиях.\n"\
