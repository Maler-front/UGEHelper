...
class FirstTemplate(BaseTaskClass):
    ...
    def get_text(self):
        return f"Известно, что в треугольнике ABC AB = BC = {self.ab}, AC = {self.ac} . Найдите длину медианы BM ."

    def get_image(self):
        return Image.open(os.path.dirname(os.path.abspath(__file__)) + "/img.png")
